...
describe('FilmService', () => {
  ...
  describe('create', () => {
    it('should create film', async () => {
      ...
      expect(film.title).toEqual(mockFilm.title);
      expect(film.episode_id).toEqual(mockFilm.episode_id);
      expect(film.opening_crawl).toEqual(mockFilm.opening_crawl);
      expect(film.director).toEqual(mockFilm.director);
      expect(film.producer).toEqual(mockFilm.producer);
      expect(film.characters).toEqual(mockFilm.characters);
      expect(film.planets).toEqual(mockFilm.planets);
      expect(film.starships).toEqual(mockFilm.starships);
      expect(film.vehicles).toEqual(mockFilm.vehicles);
      expect(film.species).toEqual(mockFilm.species);
      expect(film.release_date).toEqual(mockFilm.release_date);
      expect(film.created_at).toBeDefined();
      expect(film.updated_at).toBeDefined();
    });
  });
  describe('updateOne', () => {

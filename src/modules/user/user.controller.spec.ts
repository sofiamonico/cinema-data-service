  ...
  describe('create', () => {
    it('should create a user', async () => {
      ...
      const response = await request(app.getHttpServer())
        .post('/user/create')
        .send({ email: 'test@test.com', password: 'Passwordsegura123!' });
    ...
    it.each([
      ['123', 'password must be longer than or equal to 8 characters'],
      [
        '12345678s',
      ...
      'should throw an error if the password is not strong',
